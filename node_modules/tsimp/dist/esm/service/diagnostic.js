...
// anyway.
export const reportAll = (diagnostics, pretty) => diagnostics.filter(d => d.code !== 6059).map(d => report(d, pretty));
const host = {
    getCurrentDirectory: () => cwd,
    getNewLine: () => '\n',
    getCanonicalFileName,
};
export const report = (diagnostic, pretty = !!process.stderr.isTTY) => pretty ?
